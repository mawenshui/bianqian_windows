...
### Version 1.1.0 - 核心体验优化 ✅ 已完成 (2025年6月)
**主题**: 基础功能完善和用户体验提升

#### 核心功能
- ✅ 便签搜索功能 (features/search.py)
- ✅ 撤销/重做操作 (features/undo_redo.py)
- ✅ 全局快捷键 Ctrl+Shift+N/F/B (features/shortcuts.py)
- ✅ 智能窗口定位 (features/positioning.py)
- ✅ 数据备份功能 (features/backup.py)

#### 界面优化
- ✅ 主题预览功能（设置对话框内实时预览）
- ✅ 字体选择扩展（QFontComboBox + 大小/粗斜体）
- ✅ 操作反馈改进
- ✅ 托盘菜单优化

### Version 1.2.0 - 高级功能扩展 ✅ 已完成 (2025年6月)
**主题**: 提醒系统、标签管理、导入导出、模板

#### 新增功能
- ✅ 定时提醒系统 (features/reminder.py) — 一次性/每天/每周/每月
- ✅ 便签标签分组 (features/tag.py) — 标签CRUD/颜色/托盘分组
- ✅ 导入导出功能 (features/import_export.py) — TXT/Markdown/ZIP
- ✅ 便签模板系统 (features/template.py) — 5个内置模板+自定义
- ✅ 智能格式化粘贴 (features/formatter.py) — JSON/HTML/Markdown等8种格式
- ❌ 历史版本管理 (未实现)

#### 性能优化
- ✅ 异步I/O保存 (NoteSaveWorker后台线程)
- ✅ 保存防抖 (500ms防抖延迟)
- ✅ 异步I/O加载 (NoteLoadWorker后台线程)

### Version 1.3.0 / 1.3.1 - UI/性能优化 ✅ 已完成 (2026年6月)
**主题**: 右键菜单、窗口吸附、动画效果、异步I/O

#### UI 增强
- ✅ 右键上下文菜单 — 复制粘贴/主题/字体/置顶/透明度/标签/提醒/隐藏/删除
- ✅ 窗口吸附 — 屏幕边缘吸附 + 便签间边缘对齐 (SNAP_THRESHOLD=15px)
- ✅ 淡入淡出动画 (200ms淡入OutCubic / 150ms淡出InCubic)
- ✅ 透明度QActionGroup互斥选择

#### 系统集成
- ❌ Windows 通知中心集成 (使用系统托盘通知替代)
- ✅ 右键菜单集成
- ❌ 任务栏预览支持 (未实现)
- ✅ 开机启动优化
...
### Version 1.5.0 - 安装部署优化 ✅ 已完成 (2026年6月)
**主题**: 安装体验和品牌统一

#### 安装优化
- ✅ MSI 安装路径自动追加 StickyNote 子目录
- ✅ 构建产物统一输出到 dist/ 目录

#### 品牌统一
- ✅ 所有作者名称统一为 MaWenshui
- ✅ MSI 文件命名规范化为 ASCII 名称

### Version 1.5.1 - 更新体验优化 ✅ 已完成 (2026年6月)
**主题**: 手动检查更新的体验优化

#### 更新检查优化
- ✅ 手动检查更新时显示实时进度（状态消息 + 不确定进度条）
- ✅ 支持取消正在进行的版本检查
- ✅ 检查超时从 15 秒延长至 30 秒，适应国内网络环境
- ✅ 检查失败/成功时在设置界面显示状态信息
